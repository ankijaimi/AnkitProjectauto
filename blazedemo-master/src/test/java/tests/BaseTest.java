...
public class BaseTest {
    ...
    public void launchBrowser(String browserName){
        try{
        	System.out.println("parameter recived"+browserName);
            if(browserName.equals("chrome")){
            	System.setProperty("webdriver.chrome.driver", "C:\\Users\\admin\\Desktop\\blazedemo-master (1)\\blazedemo-master\\src\\test\\resources\\Driver\\chromedriver.exe");
